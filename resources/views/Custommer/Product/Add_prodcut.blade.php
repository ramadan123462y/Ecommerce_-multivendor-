                            ...
                            <div class="tab-content pt-2" id="myTabjustifiedContent">
                                ...
                                <div class="tab-pane fade show active" id="home-justified" role="tabpanel"
                                    ...
                                    {{-- <div class="row mb-3">
                                        ...
                                        <label for="inputColor" class="col-sm-2 col-form-label">Color Two</label>
                                        <div class="col-sm-1">
                                            <input type="color"  name="colore[]" class="form-control form-control-color"
                                                id="exampleColorInput" value="#4154f1" title="Choose your color">
                                        </div>
                                        <label for="inputColor" class="col-sm-2 col-form-label">Color Three</label>
                                        <div class="col-sm-1">
                                            <input type="color"  name="colore[]" class="form-control form-control-color"
                                                id="exampleColorInput" value="#4154f1" title="Choose your color">
                                        </div>
                                        <label for="inputColor" class="col-sm-2 col-form-label">Color Four</label>
                                        <div class="col-sm-1">
                                            <input type="color"  name="colore[]" class="form-control form-control-color"
                                                id="exampleColorInput" value="#4154f1" title="Choose your color">
                                        </div>
