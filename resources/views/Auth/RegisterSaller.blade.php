                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Create an Shop</h5>
                                        <p class="text-center small">Enter your personal details to create account</p>
                                    </div>

                                    <form class="row g-3 needs-validation" novalidate action="{{ url('saller/save') }}"
                                        method="POST">
                                        @csrf
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">Your Name Shop</label>
                                            <input type="text" name="name_store" class="form-control" id="yourName"
                                                required>
                                            <div class="invalid-feedback">Please, enter your name Shop!</div>
                                        </div>
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Name Manager:</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="text" name="name_manager" class="form-control"
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Create Shop</button>
                                        </div>
                                        <div class="col-12">
