                                ...
                                <div class="tab-pane fade show active" id="home-justified" role="tabpanel"
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-select" name="categorie_id"
                                                ...
                                                @foreach (\App\Models\Categorie::all() as $categorie)
                                                    <option value="{{ $categorie->id }}" @selected($categorie->id == $product->categorie->id)>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-select" name="brand_id"
                                                aria-label="Default select example">
                                                <option disabled>Open this brand</option>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">small
                                            Descreption</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" value="{{ $product->small_description }}"
                                                name="small_description" style="height: 60px">
                                    ...
                                    <fieldset class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check">
                                                <input class="form-check-input" @checked($product->status == 1)
                                                    type="radio" name="status" id="gridRadios1" value="1">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    @checked($product->status == 0) name="status" id="gridRadios2"
                                                    value="0">
                                    ...
                                    <fieldset class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    @checked($product->trending == 1) name="trending" id="gridRadios13"
                                                    value="1">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    @checked($product->trending == 0) name="trending" id="gridRadios24"
                                                    value="0">
                                ...
                                <div class="tab-pane fade" id="profile-justified" role="tabpanel"
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Meta
                                            Descreption</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" value="{{ $product->meta_descreption }}"
                                                style="height: 50px">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" value="{{ $product->meta_keyword }}"
                                                style="height: 50px">
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-select" name="colore[]" multiple
                                                ...
                                                @foreach (\App\Models\Colore::all() as $colore)
                                                    <option value="{{ $colore->id }}"
                                                        style="background-color:{{ $colore->colore }}; color:#fff;">
                                                        Colore
                                                    </option>
                                                @endforeach
                                            </select>
